...
const dbDietsByName = async (dietName: string) => await dietModel.find({ name: dietName });
...
export { saveDiets, dbDiets, dbDietsByName, dbDietsByID, addRecipeToDietsCollection };
