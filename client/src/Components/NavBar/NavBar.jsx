...
export default function NavBar({allDiets, handleSort, handleFilterDiets, handleFilterCreated, handleSortByHealthScore, setCurrentPage, recipesPage, allRecipes, paginado, reloadClick}) {
  return (
